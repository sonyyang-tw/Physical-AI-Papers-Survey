...
section: wm
page_id: "1955665089"
permalink: /zh/wm/dreamdojo-a-generalist-robot-world-model-from-large-scale-human-videos-1955665089/
---
...
**關鍵方法圖** ： ![Figure]({{ site.baseurl }}/assets/images/1955665089_dreamdojo_overview.png) 展示 DreamDojo 整體流程：從 44K 小時人類第一人稱影片出發，經連續潛在動作提取與預訓練，到後訓練對齊機器人具身，最終支援遠端操作、策略評估、模型式規劃等下游應用。 ![Figure]({{ site.baseurl }}/assets/images/1955665089_dreamdojo_benchmark.png) 展示在多個分布外（OOD）benchmark 上的系統性評測結果，驗證模型模擬開放世界、接觸豐富任務的能力。
